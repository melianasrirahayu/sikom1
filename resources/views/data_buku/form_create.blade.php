                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    ...
                    <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <selact name="buku_id id""" class="form-control">
                                <option value="" selection disable>Pilih Buku/label>
                                @foreach ($buku as $dt)
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" placeholder="Enter your Tahun Terbit "name="tahun terbit" type="number">
                        </div>
                    </div>
